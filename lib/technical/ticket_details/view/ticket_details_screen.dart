...
class DetailsTicketTScreen extends StatelessWidget {
                            ...
                            children: [
                                  ...
                                  Expanded(
                                      ...
                                      child: Wrap(
                                        children: [
                                          ...
                                          Text(
                                            '${intl.DateFormat.yMEd().add_jms().format(map['report_date_time'])}',
                                            style: TextStyle(
                                                color: mainColor, height: 1.5),
                                          ),
                                        ],
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                    '${intl.DateFormat.yMd().format(map['report_done_from'])}',
                                    style: TextStyle(
                                      color: Colors.red,
                                    ),
                                  ),
                                  ...
                                  Text(
                                    '${intl.DateFormat.yMd().format(map['report_done_to'])}',
                                    style: TextStyle(
                                      color: Colors.red,
                                    ),
                                  ),
