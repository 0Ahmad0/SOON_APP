                                      ...
                                      Expanded(
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            ...
                                            Get.back();
                                            showCustomDialog(
                                              text: (actionSend!="")?actionSend:'تم إحالة البلاغ الي خدمة العملاء',
                                            );
                                            Timer(Duration(
                                                seconds: 1),
                                                    (){
                                      ...
                                      Expanded(
                                        child: Row(
                                          children: [
                                            ...
                                            CircleAvatar(
                                              radius: 5.r,
                                              backgroundColor: FirebaseController.report["الحالة"]!="جديدة" //map!['report_status']
                                                  ?Color(0xff30D852).withOpacity(.5)
                                                  :Color(0xffBFBFBF),
                                            ),
                                            SizedBox(width: 5.w,),Text(
                                            (FirebaseController.report["الحالة"]!="جديدة" )?"تم تعيين فني":FirebaseController.report["الحالة"]
                                              //'${map!['ticket_status']}'
                                              ,style: TextStyle(
                                              color: FirebaseController.report["الحالة"]!="جديدة" //map!['report_status']
                                                  ?Color(0xff30D852)
                                                  :Color(0xffBFBFBF),
                                            ),),
                                          ],
